...
class SimilarTableNamesITCase extends PostgresTestBase {
     ...
     * underscore '_' in 'sch_test' matches the 'x' in 'schxtest'. Since both schemas contain a table
     * named 'cross_schema_tbl', a TABLE_NAME-only filter cannot tell them apart.
     *
